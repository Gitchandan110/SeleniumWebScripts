...
public class SK_LA_PollGroups extends Base {
	...
	public void launchSKApp() throws Exception {
        ...
        System.out.println("SK_LA_PollGroups Started");
	    	
	}

	@Test()

	public void PollGroups() throws Exception {

		
    loginSKbl.loginLA();
    homePageMenuBL.verifyHamburgerMenu();
    menuList.clickMenuCommunications();
   	menuList.clickPolling();
    menuList.clickPollGroups();
