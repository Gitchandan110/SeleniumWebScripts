...
public class SK_LA_ManageVirtualAlarms extends Base {
	...
	public void launchSKApp() throws InterruptedException, IOException {
        ...
        System.out.println("SK_LA_ManageVirtualAlarms Started");
	    	
	}

	@Test()

	public void ManageVirtualAlarms() throws IOException, InterruptedException {
    	...
    	menuList.clickManageVirtualAlarms();
	}
