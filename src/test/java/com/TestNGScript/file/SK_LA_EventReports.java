...
public class SK_LA_EventReports extends Base {
	...
	public void EventReports() throws IOException, InterruptedException {
    	...
    	reportsbl.clickEventsHistoryReport();
       	reportsbl.clickTabEventHistory();
