...
public class SK_LA_ManageAlarmDevices extends Base {
	...
	public void launchSKApp() throws InterruptedException, IOException {
        ...
        System.out.println("SK_LA_ManageAlarmDevices Started");
	    	
	}

	@Test()

	public void ManageAlarmDevices() throws IOException, InterruptedException {
    	...
    	menuList.clickManageAlarmDevices();
	}
