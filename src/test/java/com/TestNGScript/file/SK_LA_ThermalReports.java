...
public class SK_LA_ThermalReports extends Base {
	...
	public void ThermalReports() throws IOException, InterruptedException {
    	...
    	menuList.clickAllReports();
       	reportsbl.clickThermalScanAlertsReports();
       	reportsbl.clickThermalScanDashboardReports();
       	reportsbl.clickThermalScanHistoryReports();
