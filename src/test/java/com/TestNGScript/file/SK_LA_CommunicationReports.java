...
public class SK_LA_CommunicationReports extends Base {
	...
	public void CommunicationReports() throws IOException, InterruptedException {
    	...
    	reportsbl.clickCommunicationHistoryReports();
