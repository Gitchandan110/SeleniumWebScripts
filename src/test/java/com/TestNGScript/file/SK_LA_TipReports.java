...
public class SK_LA_TipReports extends Base {
	...
	public void TipReports() throws IOException, InterruptedException {
    	...
    	menuList.clickAllReports();
       	reportsbl.clickTipHistoryReports();
       	reportsbl.clickTipsByCategoryReports();
       	reportsbl.clickIncomingTipsByDayTimeReports();
